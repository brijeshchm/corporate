				...
				<div class="row">
					...
					<div class="col-md-10">
		                ...
		                <div class="tab-content">
							...
							<td><?php echo isset($_GET['card_holder_name'])?$_GET['card_holder_name']:""; ?></td>
							</tr>
							<tr>
							<th>Email</th>
							...
							<td><?php echo isset($_GET['billing_country'])?$_GET['billing_country']:""; ?></td>
							</tr>
							<tr>
							<th>City</th>

							<td><?php echo isset($_GET['city'])?$_GET['city']:""; ?></td>
							</tr>
												 
							
							<tr style="border:none">
							<td>
							<a href="javascript:void(0);" id="invoicePrintPdf" class="btn btn-primary" data-sid="<?php echo $_GET['order_id']; ?>">Print</a></td>
							</tr>
...
<script type="text/javascript">
 /*  $(document).on('click', '#razor-pay-now', function (e) {
  ...
  //  var key_id = "<?php echo RAZOR_KEY_ID; ?>";
    var store_name = 'Institute Pvt Ltd';
    var store_description = 'Fees Pay';
    var store_logo = 'https://www.techpratham.com/wp-content/themes/techpratham/assets/image/logo.png';
