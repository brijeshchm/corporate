...
function customedia(x) {
  if (x.matches) {
    ...
    document.getElementById("fix-frm-id").style.display = "none";
    document.getElementById("certificate-preview").style.display = "none";
    document.getElementById("self-img").style.display = "none";
    document.getElementById("menuPopupCrsCls").style.display = "none";
    document.getElementById("mobile-icon-disable").style.display = "none";
    // master program page
    document.getElementById("master-container-page").style.display = "none";
  } else {
   document.getElementById("nav-items").style.display = "block";
   document.getElementById("fix-frm-id").style.display = "block";
   document.getElementById("certificate-preview").style.display = "block";
   document.getElementById("self-img").style.display = "block";
   document.getElementById("menuPopupCrsCls").style.display = "block";
   document.getElementById("mobile-icon-disable").style.display = "block";
   // master program page
   document.getElementById("master-container-page").style.display = "block";
  }
}
var x = window.matchMedia("(max-width: 440px)")
customedia(x) 
x.addListener(customedia); */
//media query end for mobile
...
//sticky navigation bar in course page start
...
//sticky navigation bar in course page end
